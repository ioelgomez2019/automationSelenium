...
/**
 * DriverManager - Gestor central del WebDriver.
 * Gestiona el ciclo de vida del WebDriver (crear, obtener, destruir).
 * Usa ThreadLocal para soporte multi-hilo y ejecución paralela.
 * 
 * Arquitectura: Core Component (Singleton + ThreadLocal)
 */
public class DriverManager {
    ...
    public static void iniciarDriver() {
        ConfigManager config = ConfigManager.getInstance();        String browser   = config.getBrowser().toLowerCase();
